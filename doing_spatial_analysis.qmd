...
3.  *Measure access to parks:* We will use a plug-in to create a **service area** around each park. This will show which areas are within a 10-minute walk from the park
