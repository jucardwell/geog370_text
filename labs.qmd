...
You should submit a set of three maps. Each map should display **ONLY** the dataset of interest with appropriate symbology. Each map should follow all guidance in the Cartography Basics section. **Map 1** should display the median household income values of only high population density tracts in the Triangle region of North Carolina (**Hint:** this will require either a new spatial join or a new selection). **Map 2** should display the elevation across Orange County. **Map 3** should display maximum temperature at weather stations across North Carolina during the June 2024 heatwave.

For the metadata, The census data is from the American Community Survey, the elevation data is from NCOneMap, the temperature data is from NC State Climate Office.
